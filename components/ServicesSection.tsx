...
const services = [
  {
    ...
    description: "Empowering individuals and teams through hands-on, industry-relevant training in ICT, software development, AI, and digital tools.",
    icon: Lightbulb,
  },
  {
    title: "IT & Business Consultancy",
    description: "Providing expert guidance to help businesses optimize technology, streamline operations, and scale with confidence.",
    icon: BriefcaseBusiness,
  },
  {
    title: "AI Automation & Digital Transformation",
    description: "Designing and deploying smart AI solutions that automate workflows, enhance productivity, and unlock business potential.",
    icon: Brain,
  },
  {
    title: "Custom Web & App Development",
    description: "Building tailored, scalable, and user-friendly web and mobile applications that align with client goals and user needs.",
    icon: Code,
  },
  {
    title: "Business Innovation & Advisory Services",
    description: "Delivering strategic insights and data-driven advisory for startups and SMEs, helping them innovate, grow, and stay competitive.",
    icon: TrendingUp,
  },
  {
    title: "Cybersecurity & Data Protection",
    description: "Safeguarding your digital assets with robust cybersecurity strategies, threat detection, incident response, and data privacy compliance.",
    ...
    >
      ...
      <div className="absolute inset-0 z-0 opacity-5 dark:opacity-10 pointer-events-none">
        <svg className="h-full w-full" fill="none">
          <defs>
            <pattern id="service-grid-pattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
              <path d="M20 0L0 0L0 20" stroke="currentColor" strokeWidth="0.5" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#service-grid-pattern)" className="text-byteops-primary dark:text-byteops-secondary" />
        </svg>
      </div>

      <div className="container mx-auto px-4 relative z-10"> {/* Ensure content is above background elements */}
        <motion.h2
            ...
            <motion.div key={index} variants={itemVariants}>
              ...
              >
                ...
                <CardContent className="flex-grow text-center">
                  <CardDescription
                    className="text-gray-700 dark:text-gray-300 text-base leading-relaxed" // Adjusted card description color for readability
                  >
                    {service.description}
                  </CardDescription>
                </CardContent>
